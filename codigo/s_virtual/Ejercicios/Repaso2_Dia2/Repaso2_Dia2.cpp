...
/*
 ...
 en una estructura, debemos crear una variable de la estructura para guardar ahi los datos que deseemos.
...
void pausarConsola()
{
  cout << "Para continuar presiona cualquier tecla =D =D =D ...\n";
  cin.get();
  cin.ignore();
}
...
int main()
{
  ...
  do {
    ...
    default:
      cout << "La opcion que ingresaste no es valida. Por favor, ingresa una opcion valida.\n";
      pausarConsola();
      break;
    }
  } while (opcion != 0);

  cout << "Presiona una tecla para finalizar la aplicacion.\n";
  //Este par de instrucciones funcionan como un system("pause")
  cin.get();
  cin.ignore();
}
...
void inicializarEstructuras()
{
  ...
  */
  ...
  per2.apellido = "Garza Garcia";
  per3.edad = 50;
  per4.alturaEnMetros = 1.50;
  per4.nombre = "Mario";
  per4.apellido = "Bros";
...
void crearEstructurasConArreglos()
{
  ...
  */
  ...
  for (int i = 2; i < 8; i++)
  {
    cout << " - " << calendario.meses[i] << endl; // usamos la varible i como indice para imprimir los meses restantes
  }
...
void crearArreglosDeEstructuras()
{
  ...
  // Nuestro juego puede tener 1 personaje principal, y hasta 1000 enemigos.
  Personaje heroe;
  ...
  // Vamos a inicializar los datos o miembros de nuestro heroe
  heroe.nombre = "Marco";
...
void crearEstructurasAnidadas()
{
  ...
  // Cada poder tendra un nombre y bonus de ataque y defensa, este bonus a los puntos de ataque del personaje
  struct Poder
  {
    string nombre;
    int bonusDeAtaque;
  ...
  for (int i = 0; i < 3; i++)
  {
    ...
    */
    heroe.puntosDeAtaque += heroe.poderes[i].bonusDeAtaque; 
    heroe.puntosDeDefensa += heroe.poderes[i].bonusDeDefensa;

  }
  cout << " >>>>> TOTAL ATK................" << heroe.puntosDeAtaque << endl;
  cout << " >>>>> TOTAL DEF................" << heroe.puntosDeDefensa << endl;
